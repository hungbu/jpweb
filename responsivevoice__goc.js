...
if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
        ...
        var voicecollection = [
            ...
            {name: 'Google 日本人', timerSpeed:0.5}, //50 JP Chrome 
        ...
        self.startTimeout = function (text, callback) {
           ...
           if (multiplier <=0)
            ...
            self.timeoutId = setTimeout(callback, multiplier * 1000 * (180 / WORDS_PER_MINUTE) * text.split(/\s+/).length); //avg 140 words per minute read time            
